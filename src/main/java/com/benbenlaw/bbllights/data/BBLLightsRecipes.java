...
public class BBLLightsRecipes extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        shaped(RecipeCategory.MISC, BBLLightsItems.IRON_INVISIBLE_LIGHT_PLACER.get())
                ...
                .pattern("ILI")
                .pattern(" I ")
                .define('I', ModdedTagBuilder.createNeoFabricItemTag("ingots/iron"))
                .define('C', ModdedTagBuilder.createNeoFabricItemTag("storage_blocks/coal"))
        ...
        shaped(RecipeCategory.MISC, BBLLightsItems.DIAMOND_INVISIBLE_LIGHT_PLACER.get())
                ...
                .pattern("DID")
                .pattern(" D ")
                .define('D', ModdedTagBuilder.createNeoFabricItemTag("gems/diamond"))
                .define('C', ModdedTagBuilder.createNeoFabricItemTag("storage_blocks/coal"))
